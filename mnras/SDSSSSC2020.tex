...
Note an overall gradient of $\sim0.02$ mag from the bright to the faint end -- a comparison 
of the SDSS catalog with Pan-STARRS and DES catalogs (see Figure~\ref{fig:drVSr}) 
suggests that its origin is a bias in Gaia's EDR3 photometry rather than a problem with 
SDSS photometry.}
\label{fig:gaiaJump}
\end{figure}
...
XXX REMOVE THIS SECTION AND FIGURE 
...
The variation of the magnitude differences with magnitude (see Figure~\ref{fig:drVSr}) is flat to 
within $\sim$5 millimag (recall that differences with respect to Gaia Gmag magnitudes show
a much larger bright-to-faint-end gradient of $\sim$20 mag). This much smaller gradient 
implies a likely problem with Gaia EDR3 photometry at the 0.01-0.02 mag level.   
